...
该特性是通过 numactl 来读取服务器上的 numa 信息，也支持手动配置，详见 [NUMA awareness support for launching containers](https://issues.apache.org/jira/browse/YARN-5764)。
...
Java 也有一个 [Java-Thread-Affinity](https://github.com/OpenHFT/Java-Thread-Affinity) 项目，支持通过 API 方式对线程进行邦核：
...
![img](https://gitee.com/zhxuankun/Image/raw/master/blog/image.png)
